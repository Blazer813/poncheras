...
<html lang="en">
  ...
  <body class="app sidebar-mini">
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i class="bi bi-person fs-4"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="{{ route('logout') }}"><i class="bi bi-box-arrow-right me-2 fs-5"></i> Cerrar Sesión </a></li>
          </ul>
        </li>
      </ul>
    </header>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="bi bi-speedometer"></i> Inicio</h1>
        </div>
      ...
      {{-- <div id="app">
        <movimientos-index-component></movimientos-index-component>
      </div>       --}}
