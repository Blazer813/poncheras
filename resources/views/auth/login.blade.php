    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" method="POST" action="{{ route('login') }}">
          ...
          <div class="mb-3">
            <x-input-label for="email" class="form-label" :value="__('CORREO')" />
            <br>
            <x-text-input id="email" class="form-control" type="email" placeholder="Correo" name="email" :value="old('email')" required autofocus autocomplete="username" />
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <label for="remember_me" class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Permanecer Conectado') }}</span>
                </label>
                </label>
              </div>
          ...
          <div class="mb-3 pb-3 btn-container d-grid">
